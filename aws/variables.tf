...
variable "provider_network_id_requested" {
  description = "Cloud provider network ID request"
  default     = ""
}
...
variable "provider_subnet_id_requested" {
  description = "Cloud provider subnet ID request"
  default     = ""
}
